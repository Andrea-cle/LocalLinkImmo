...
/>
      ...
      <div>
        <label
        htmlFor='confirmPass'> Confirmer le mot de passe :</label>
        <input
        type='password'
        id='confirmPass'
        name='confirmPass'
        ...
        onChange={handleConfirmPassChange} required
        />
      </div>
      <div>
      ...
      >
        <option
        value=''>Selectionnez un rôle :</option>
        <option
        value='Locataire'>Locataire</option>
        <option
